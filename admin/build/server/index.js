...
const storage = process.env.NODE_ENV === "development" ? { kind: "local" } : {
  kind: "github",
  repo: {
    owner: "q1b",
    name: "q1b"
    ...
    person: singleton({
      ...
      schema: {
        ...
        email_address: fields.text({
          label: "Email Address",
          description: "Be aware of the email address you are typing as this is going to be visible to everyone who is going to visit this website!"
        }),
        image: fields.image({
          label: "Profile Image",
            ...
            true: fields.object(
              {
                ...
                media: fields.array(
                  ...
                  {
                    label: "Media",
                    description: "Letter of Recommendation, Certificates, etc."
                  }
                ),
                company: fields.object(
                  ...
                  {
                    label: "Company",
                    description: "Details of the Company you worked for."
                  }
                )
              },
              {
